...
export default function Home() {
  return (
    <Layout home>
      ...
      <header>
        <h1
          className={`${utilStyles.headingLg} ${homeStyles.title} ${homeStyles.headings}`}
        >
          {siteTitle}
        </h1>
      ...
      <div>
        <h2 className={`${homeStyles.headings} ${homeStyles.aboutMe}`}>
          About Me
        </h2>
        <p className={homeStyles.subtitle} style={{ fontWeight: "200" }}>
          Hi! I'am Shubham, a 24 y/o Software Engineer. I love to solve complex
          problems and build products & experiences. Currently completing my
          M.S. in Computer Science from Stony Brook University, NY. Looking
          forward to sharing my knowledge via blog articles, conferences etc.
          <br />
          <br />
